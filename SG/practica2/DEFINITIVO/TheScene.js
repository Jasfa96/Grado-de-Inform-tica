...
TheScene = function (renderer) {
  ...
  var createModel = function () {
    var sol = new Estrella (20, 120000, 'sun.jpg', 40000);
    var mercurio = new Astro (2, 5000, 'mercurio.jpg', 35, 5500);
    var venus = new Astro (4, 9000, 'venus.jpeg', 75, 8500);
    var tierra = new Astro (4, 5000, 'tierra.jpeg', 85, 10500);
    var marte = new Astro (2.5, 6000, 'marte.jpeg', 105, 7500);
    var jupiter = new Astro (9, 12000, 'jupiter.jpg', 140, 21000);
    ...
    var luna= new Astro(0.75,1000,"luna.jpeg",6, 3000);
    var fobos= new Astro(0.65,1000,"fobos.jpg",4, 2500);
    var deimos= new Astro(0.4,1800,"deimos.jpg",6, 2000);
    var io= new Astro(1,1800,"io.jpeg",8, 4000);
    var europa= new Astro(1.5,3000,"europa.jpg",10, 5000);
    var calisto= new Astro(3,10000,"calisto.jpeg",14, 8000);
  ...
  // public
/*
  this.startStop = function (controls.startStop) {
     model.startStop(this.controls.startStop);
   }
*/
