...
struct introducirdns_1_argument {
	nombre arg1;
	ip arg2;
};
typedef struct introducirdns_1_argument introducirdns_1_argument;
...
#define consultar 3
extern  char ** consultar_1(nombre , ip , CLIENT *);
extern  char ** consultar_1_svc(nombre , ip , struct svc_req *);
#define introducirdns 4
extern  void * introducirdns_1(nombre , ip , CLIENT *);
extern  void * introducirdns_1_svc(nombre , ip , struct svc_req *);
#define eliminardns 5
extern  void * eliminardns_1(nombre , CLIENT *);
extern  void * eliminardns_1_svc(nombre , struct svc_req *);
...
#define introducirdns 4
extern  void * introducirdns_1();
extern  void * introducirdns_1_svc();
#define eliminardns 5
extern  void * eliminardns_1();
extern  void * eliminardns_1_svc();
...
extern  bool_t xdr_introducirdns_1_argument (XDR *, introducirdns_1_argument*);
...
extern bool_t xdr_introducirdns_1_argument ();
