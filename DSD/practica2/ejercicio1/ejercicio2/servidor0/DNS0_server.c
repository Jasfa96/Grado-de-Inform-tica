 ...
 introducir_1_svc(nombre arg1, red arg2, ip arg3,  struct svc_req *rqstp)
 {
 	static char * result;
  	if(strcmp(arg2,redusada)==0){
 		...
 		result="ESTA ES LA RED1, INTRODUCE LOS VALORES USANDO Red0";
  	}
 	return &result;
 }
 ...
 eliminar_1_svc(nombre arg1, red arg2,  struct svc_req *rqstp)
 {
 	...
 	if(strcmp(arg2,redusada)==0){
       ...
       printf("%s\n", "BORRADO correctamente");
 		...
 		printf("%s\n", "ESTA ES LA RED0, INTRODUCE LOS VALORES USANDO Red1");
 		result="ESTA ES LA RED 0, INTRODUCE VALORES USANDO Red1";
  	}
