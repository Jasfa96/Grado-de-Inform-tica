	...
	static char * result;
 	if(strcmp(arg2,redusada)==0){
		...
		result="HA SIDO INTRODUCIDO";
 		...
 		printf("%s\n", "ESTA ES LA Red2, INTRODUCE LOS VALORES USANDO Red2");
		result="ESTA ES LA Red2, INTRODUCE LOS VALORES USANDO Red2";
 	}
	return &result;
}
...
eliminar_1_svc(nombre arg1, red arg2,  struct svc_req *rqstp)
{
	...
	if(strcmp(arg2,redusada)==0){
      ...
      printf("%s\n", "BORRADO correctamente");
		...
		printf("%s\n", "ESTA ES LA Red2, INTRODUCE LOS VALORES USANDO Red2");
		result="ESTA ES LA RED 2, INTRODUCE VALORES USANDO Red2";
 	}
