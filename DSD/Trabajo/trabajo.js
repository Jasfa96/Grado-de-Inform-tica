...
function accionAire(val1) {
	if (val1>=25){estadoAire="Aire acondicionado encendido";otroestadoAire="Aire acondicionado encendido"; return "Aire acondicionado encendido";}
...
function accionPersiana(val2) {
	if (val2>=60){estadoPersiana="Bajo persianas"; otroestadoPersiana="Bajo persianas"; return "Bajo persianas";}
